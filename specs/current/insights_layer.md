...
# Goal: Identify enrollment patterns and low-performing courses to support
...
#     1. Course popularity ranking (enrollments per course, sorted descending)
...
#     4. Low-enrollment course flagging (bottom 20% by enrollment count)

# Constraints:
#   - Filter out invalid ages (age < 0 or age > 100) before any age analysis
#   - No hardcoded thresholds — low-enrollment cutoff calculated dynamically
